...
if dataset_name_test in ["ZeroShotDeconvNet"]:
    path_fig = os.path.join(
        "outputs", "figures", dataset_name_test.lower(), "Mitosis", wave_length
    )
else:
    path_fig = os.path.join(
        "outputs",
        "figures",
        dataset_name_test.lower(),
...
if dataset_name_test in ["SimuMix3D_128", "SimuBeads3D_128", "SimuMix3D_256"]:
    ...
    lr_root_path = os.path.join(
        path,
        f"raw_psf_31_gauss_{std_gauss}_poiss_{poisson}_sf_{scale_factor}_ratio_{ratio}",
    )
...
if dataset_name_test in ["SimuMix3D_382"]:
    ...
    hr_root_path = os.path.join(path, "gt")
    lr_root_path = os.path.join(
        path, f"raw_psf_101_noise_{std_gauss}_sf_{scale_factor}_ratio_{ratio}"
    )
...
if dataset_name_test in [
    ...
    path = os.path.join(
        root_path, "RCAN3D", "Confocal_2_STED", dataset_name_test
    )
...
dataset_test = utils_data.SRDataset(
...
if FP_type == "pre-trained":
    ...
    if dataset_name_train == "SimuMix3D_128":
        ...
        FP_path = os.path.join(
            "checkpoints",
            dataset_name_train,
            "forward",  # 'kernet_fp_bs_1_lr_0.0001_ker_{}_noise_{}_sf_{}_mse_over2_inter_norm'\
            f"kernet_fp_bs_2_lr_1_ker_{ker_size_fp}_gauss_{std_gauss}_poiss_{poisson}_sf_{scale_factor}_mse_over2_inter_normx_fft_ratio_{ratio}_ts_0_2_s100",  # 'epoch_5000.pt') # 10000 (NF), 5000 (N)
            "epoch_20.pt",
        )  # 10000 (NF), 5000 (N)
    ...
    if dataset_name_train == "SimuMix3D_256":
        ...
        FP_path = os.path.join(
            ...
            dataset_name_train,
            "forward",
            f"kernet_fp_bs_1_lr_1_ker_{ker_size_fp}_gauss_{std_gauss}_poiss_{poisson}_sf_{scale_factor}_mse_over2_inter_normx_fft_ratio_{ratio}_ts_3_4_s100",
            "epoch_10.pt",
        )  # 50 (NF), 10 (N)
    ...
    if dataset_name_train == "F-actin_Nonlinear":
        ...
        FP_path = os.path.join(
            "checkpoints",
            dataset_name_train,
            "forward",  # 'kernet_fp_bs_1_lr_0.001_ker_{}_noise_{}_sf_{}_mse_over2_inter_norm_fft_ratio_1'\
            f"kernet_fp_bs_1_lr_0.001_ker_{ker_size_fp}_gauss_{std_gauss}_poiss_{poisson}_sf_{scale_factor}_mse_over2_inter_normx_fft_ratio_1_ts_0_1_s100",  # 'epoch_5000.pt')
            "epoch_500.pt",
        )
    ...
    if dataset_name_train == "Microtubules2":
        ...
        FP_path = os.path.join(
            "checkpoints",
            dataset_name_train,
            "forward",  # 'kernet_fp_bs_1_lr_0.001_ker_{}_noise_{}_sf_{}_mse_over2_inter_norm_fft_ratio_1_0'\
            f"kernet_fp_bs_1_lr_0.001_ker_{ker_size_fp}_gauss_{std_gauss}_poiss_{poisson}_sf_{scale_factor}_mse_over2_inter_normx_fft_ratio_1_ts_0_1_s100",  # 'epoch_5000.pt')
            "epoch_500.pt",
        )
...
if BP_type == "learned":
    ...
    if dataset_name_train == "SimuMix3D_128":
        ...
        model_path = os.path.join(
            ...
            dataset_name_train,
            "backward",
            f"kernet_bs_3_lr_1e-06_iter_{num_iter_train}_ker_{ker_size_bp}_gauss_{std_gauss}_poiss_{poisson}_sf_{scale_factor}_lam_0.0_mse_over2_inter_norm_fft_ratio_{ratio}_ts_0_3",  # 'epoch_5000.pt')
            "epoch_10000.pt",
        )
    ...
    if dataset_name_train == "SimuMix3D_256":
        model_path = os.path.join(
            "checkpoints",
            dataset_name_train,
            f"kernet_bs_1_lr_0.0005_iter_{num_iter_train}_ker_{ker_size_bp}_gauss_{std_gauss}_poiss_{poisson}_sf_{scale_factor}_lam_0.0_mse_over4_inter_norm_fft_ratio_{ratio}_ts_0_1_abss_mo",
            "epoch_1000.pt",
        )
    ...
    if dataset_name_train == "SimuMix3D_382":
        ...
        if wave_length == "642":
            model_path = os.path.join(
                "checkpoints",
                dataset_name_train,
                "backward",  # 'kernet_bs_1_lr_1e-07_iter_{}_ker_{}_gauss_{}_poiss_{}_sf_{}_lam_0.0_mse_over2_inter_norm_fft_ratio_{}_ts_0_1_642'\
                f"kernet_bs_1_lr_1e-07_iter_{num_iter_train}_ker_{ker_size_bp}_gauss_{std_gauss}_poiss_{poisson}_sf_{scale_factor}_lam_0.0_mse_over2_inter_norm_fft_ratio_{ratio}_ts_0_9_642",  # 'epoch_6000.pt')
                "epoch_4000.pt",
            )
        ...
        if wave_length == "560":
            model_path = os.path.join(
                "checkpoints",
                dataset_name_train,
                "backward",  # 'kernet_bs_1_lr_1e-07_iter_{}_ker_{}_gauss_{}_poiss_{}_sf_{}_lam_0.0_mse_over2_inter_norm_fft_ratio_{}_ts_0_1_560'\
                f"kernet_bs_1_lr_1e-07_iter_{num_iter_train}_ker_{ker_size_bp}_gauss_{std_gauss}_poiss_{poisson}_sf_{scale_factor}_lam_0.0_mse_over2_inter_norm_fft_ratio_{ratio}_ts_0_9_560",  # 'epoch_6000.pt')
                "epoch_4000.pt",
            )
    ...
    if dataset_name_train == "ZeroShotDeconvNet":
        model_path = os.path.join(
            "checkpoints",
            dataset_name_train,  # 'kernet_bs_1_lr_1e-07_iter_{}_ker_{}_noise_{}_sf_{}_lam_0.0_mse_over2_inter_norm_fft_ratio_{}_101x101_642_ss'\
            f"kernet_bs_1_lr_1e-07_iter_{num_iter_train}_ker_{ker_size_bp}_noise_{std_gauss}_sf_{scale_factor}_lam_0.0_mse_over2_inter_norm_fft_ratio_{ratio}_101x101_560_ss",
            "epoch_3000.pt",
        )
    ...
    if dataset_name_train == "Microtubule":
        model_path = os.path.join(
            "checkpoints",
            dataset_name_train,
            f"kernet_bs_1_lr_1e-05_iter_{num_iter_train}_ker_{ker_size_bp}_noise_{std_gauss}_sf_{scale_factor}_lam_0.0_mse_over{over_sampling}_inter_norm_1024",
            "epoch_5000.pt",
        )
    ...
    if dataset_name_train == "Nuclear_Pore_complex":
        model_path = os.path.join(
            "checkpoints",
            dataset_name_train,
            f"kernet_bs_1_lr_1e-06_iter_{num_iter_train}_ker_{ker_size_bp}_noise_{std_gauss}_sf_{scale_factor}_lam_0.0_mse_over{over_sampling}_inter_norm_1024",
            "epoch_5000.pt",
        )
    ...
    if dataset_name_train == "Nuclear_Pore_complex2":
        model_path = os.path.join(
            ...
            dataset_name_train,
            "backward",
            f"kernet_bs_4_lr_1e-05_iter_{num_iter_train}_ker_{ker_size_bp}_gauss_{std_gauss}_poiss_{poisson}_sf_{scale_factor}_lam_0.0_mse_over{over_sampling}_inter_norm_fft_ratio_1_ts_0_4",
            "epoch_10000.pt",
        )
    ...
    if dataset_name_train == "F-actin_Nonlinear":
        model_path = os.path.join(
            ...
            dataset_name_train,
            "backward",
            f"kernet_bs_1_lr_1e-05_iter_{num_iter_train}_ker_{ker_size_bp}_gauss_{std_gauss}_poiss_{poisson}_sf_{scale_factor}_lam_0.0_mse_over2_inter_norm_fft_ratio_{ratio}_ts_0_1",
            "epoch_10000.pt",
        )
    ...
    if dataset_name_train == "Microtubules2":
        model_path = os.path.join(
            "checkpoints",
            dataset_name_train,
            "backward",  # 'kernet_bs_1_lr_1e-05_iter_{}_ker_{}_noise_{}_sf_{}_lam_0.0_mse_over2_inter_norm_fft_ratio_{}_0'\
            f"kernet_bs_1_lr_0.0001_iter_{num_iter_train}_ker_{ker_size_bp}_gauss_{std_gauss}_poiss_{poisson}_sf_{scale_factor}_lam_0.0_mse_over2_inter_norm_fft_ratio_{ratio}_ts_0_1",  # 'epoch_5000.pt')
            "epoch_10000.pt",
        )
...
id_inter_plot = [
    ...
    5,
    6,
]  # the id of sampels to show the intermedia results
...
for i in id_sample:
    ...
    print("-" * 80)
    print(
        f"Sample [{i}], input shape:{list(x.shape)}, GT shape:{list(y.shape)}"
    )
    ...
    # Save results
    name_net = "kernelnet"
    path_single_data = os.path.join(
        path_fig, f"sample_{i}", name_net + suffix_net
    )
    if not os.path.exists(path_single_data):
        os.makedirs(path_single_data, exist_ok=True)

    def imsave_sample(path, fname, arr):
        return io.imsave(
            fname=os.path.join(path, fname), arr=arr, check_contrast=False
        )
